...
Este archivo provee contexto para Codex sobre el estado actual del proyecto y el plan de implementación del backend.
...
Codex, tu objetivo es ejecutar las siguientes fases paso a paso para completar la integración inicial.
